...
export const executeSuite = async (
  ...
  return prisma.$transaction(async (tx) => {
    ...
    if (suite.testCases.length === 0) throw new Error("Suite has no test cases");
...
export const completeSuiteExecution = async (
...
export const getSuiteExecutionReport = async (
  suiteExecutionId: string
) => {
