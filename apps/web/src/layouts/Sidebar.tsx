  ...
  return (
    <aside style={{
      ...
      <div style={{
        ...
        background: "linear-gradient(90deg, transparent, rgba(120,87,255,0.6), rgba(61,217,255,0.3), transparent)",
      }} />
        ...
        <div style={{
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              ...
              <div style={{ fontSize: "0.67rem", color: "var(--text-muted)", letterSpacing: "0.04em" }}>
                {user?.role}
              </div>
            </div>
          </div>
...
const NavItem = ({ icon, label, active, badge }: { icon: string; label: string; active: boolean; badge?: string }) => (
  <div style={{
