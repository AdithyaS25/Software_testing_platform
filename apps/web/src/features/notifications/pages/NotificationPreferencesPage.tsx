  ...
  return (
    <div style={{ animation: 'fadeIn 0.3s ease', maxWidth: 680 }}>
        ...
        {PREF_ROWS.map((row, i) => (
          <div
            ...
            style={{
              ...
              padding: '16px 20px',
              borderBottom:
                i < PREF_ROWS.length - 1 ? '1px solid var(--border)' : 'none',
              alignItems: 'center',
            }}
          >
            <div>
            ...
            <div style={{ display: 'flex', justifyContent: 'center' }}>
              <Toggle
                value={prefs[row.emailKey] as boolean}
            ...
            <div style={{ display: 'flex', justifyContent: 'center' }}>
              <Toggle
                value={prefs[row.inAppKey] as boolean}
      ...
      >
        {saved && (
          <span
            style={{ color: '#22c55e', fontSize: '0.85rem', fontWeight: 500 }}
          >
            ✓ Preferences saved
          </span>
        )}
