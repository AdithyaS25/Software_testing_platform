    ...
    <div style={{ animation: "fadeIn 0.3s ease" }}>
      ...
      <div className="page-header">
        ...
        <div style={{ display: "flex", gap: 8 }}>
          ...
          {notifications.length > 0 && (
            <button onClick={clearAll} style={{ ...secondaryBtnStyle, color: "#ef4444", borderColor: "#ef4444" }}>
              🗑 Clear all
            </button>
          )}
          <button onClick={() => nav("/notifications/preferences")} style={secondaryBtnStyle}>
            ⚙ Preferences
          </button>
        </div>
      </div>
      ...
      {loading ? (
        ...
        <div style={{
          ...
          <p style={{ color: "var(--text-secondary)", fontWeight: 500 }}>No notifications</p>
