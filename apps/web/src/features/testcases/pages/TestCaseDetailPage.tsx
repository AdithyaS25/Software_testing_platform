    ...
    <div style={{ animation: 'fadeIn 0.3s ease', maxWidth: 900 }}>
        ...
        >
          ...
          <div style={{ display: 'flex', gap: 8, flexShrink: 0 }}>
            {canEdit && tc.status === 'APPROVED' && (
              <Button
                variant="success"
                onClick={() => nav(`/projects/${projectId}/executions/${id}`)}
              >
                ▷ Execute
              </Button>
            )}
      ...
      >
        {[
          ...
          [
            'Est. Duration',
            tc.estimatedDuration ? `${tc.estimatedDuration} min` : '—',
          ],
        ...
        >
          ...
          >
            {[
              ...
              [
                'Created At',
                tc.createdAt ? new Date(tc.createdAt).toLocaleString() : '—',
              ],
        ...
        >
          <FormField label="Module">
            <input
              ...
              onChange={(e) =>
                setEditForm((p: any) => ({ ...p, module: e.target.value }))
              }
            />
          </FormField>
          <FormField label="Priority">
            <select
              ...
              onChange={(e) =>
                setEditForm((p: any) => ({ ...p, priority: e.target.value }))
              }
            >
          ...
          <FormField label="Severity">
            <select
              ...
              onChange={(e) =>
                setEditForm((p: any) => ({ ...p, severity: e.target.value }))
              }
            >
