...
export const TestCasesPage = () => {
  ...
  const load = () => {
    ...
    apiClient
      ...
      .then((r) => {
        setCases(r.data.items || r.data.data || r.data || []);
        setLoading(false);
      })
    ...
    <div style={{ animation: 'fadeIn 0.4s ease' }}>
      <div className="page-header">
        ...
        {canEdit && (
          <Button
            icon="+"
            onClick={() => nav(`/projects/${projectId}/test-cases/new`)}
          >
            New Test Case
          </Button>
        )}
                ...
                <tr key={tc.id}>
                  ...
                  <td style={{ overflow: 'hidden' }}>
                    ...
                    >
                      ...
                      {tc.tags?.slice(0, 1).map((t: string) => (
                  ...
                  <td>
                    <Badge color={sevColor(tc.severity) as any}>
                      {tc.severity}
                    </Badge>
                  </td>
                  <td>
                  ...
                  <td>
                    ...
                    >
                      <button
                        onClick={() =>
                          nav(`/projects/${projectId}/test-cases/${tc.id}`)
                        }
                        title="View"
                        style={{
                      ...
                      {canEdit && tc.status === 'APPROVED' && (
                        <button
                          onClick={() =>
                            nav(`/projects/${projectId}/executions/${tc.id}`)
                          }
                          title="Run"
                          style={{
