    ...
    <div style={{ animation: 'fadeIn 0.3s ease' }}>
      ...
      {loading ? (
        ...
        <EmptyState
          ...
          desc="Define milestones to track project progress against targets"
          action={
            canEdit ? (
              <Button onClick={openCreate}>Create Milestone</Button>
            ) : undefined
          }
        />
      ) : (
                ...
                >
                  <div style={{ flex: 1 }}>
                    ...
                    >
                      ...
                      <Badge color={(STATUS_COLOR[m.status] ?? 'gray') as any}>
                    ...
                    >
                      {m.targetDate && (
                        <span style={{ color: 'var(--text-muted)' }}>
                          ...
                          {due && (
                            <span style={{ marginLeft: 6, color: due.color }}>
                              ({due.label})
                            </span>
                          )}
                        </span>
                      ...
                      {m.testRuns?.length > 0 && (
                        <span style={{ color: 'var(--text-muted)' }}>
                          ▷ {m.testRuns.length} test runs linked
                        </span>
                      )}
                    </div>
                  </div>
