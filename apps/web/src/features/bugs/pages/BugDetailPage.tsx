...
export const BugDetailPage = () => {
  ...
  const deleteComment = async (cid: string) => {
    try {
      ...
      toast.error('Can only delete within 5 minutes');
    }
  };
    ...
    <div style={{ animation: 'fadeIn 0.3s ease', maxWidth: 900 }}>
      ...
      >
        ...
        >
          ...
          {isDev && nextStatuses.includes('FIXED') && (
            <Button variant="success" onClick={() => setFixModal(true)}>
              Mark Fixed
            </Button>
          )}
          ...
          {isTester && nextStatuses.includes('WONT_FIX') && (
            <Button
              variant="ghost"
      ...
      >
        ...
        >
          ...
          <Button loading={assigning} onClick={handleAssign}>
            Assign
          </Button>
        </div>
      </Modal>
      ...
      >
        ...
        >
          <Button variant="secondary" onClick={() => setFixModal(false)}>
            Cancel
          </Button>
          <Button variant="success" onClick={() => handleStatusChange('FIXED')}>
            Mark Fixed
          </Button>
        </div>
      </Modal>
